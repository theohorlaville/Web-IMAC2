...
const getEvent = async function (page_number) {
    const response = await fetch("https://app.ticketmaster.com/discovery/v2/events.json?sort=random&size=50&page=" + page_number + "&apikey=kVnQuVpoBqstFdn0E2ecQYUZHrFvPK4E")
